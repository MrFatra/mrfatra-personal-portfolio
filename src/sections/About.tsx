import { AnimatedContent, SplitText } from '@/blocks'
      ...
      <Box flexDirection={'row'} display={'flex'} gap={10} mt={4} alignItems={'center'}>
        <AnimatedContent>
          <LinkBox
            ...
            position={'relative'}
            border={'1px solid'}
            borderColor={colorMode === 'light' ? 'gray.400' : 'transparent'}
            boxShadow={'md'}
            _hover={{
